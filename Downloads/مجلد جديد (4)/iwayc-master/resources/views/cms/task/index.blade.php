            ...
            var tTable = $('#users-table').DataTable({
                ...
                columns: [
                    ...
                    {"mRender": function ( data, type, row ) {
                        ...
                        ,orderable: false},
                    { data: 'reminders_num', name: 'reminders_num' },
                    { data: 'evaluate', name: 'evaluate' },
                    {"mRender": function ( data, type, row ) {
                            var show ='<a class="btn btn-sm btn-warning" href="/CMS/Task/'+row.id+'">عرض</a>';
                            var edit ='<a class="btn btn-sm btn-info" href="/CMS/Task/'+row.id+'/edit">تعديل</a>';
