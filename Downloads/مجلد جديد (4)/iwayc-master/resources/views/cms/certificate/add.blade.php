...
<option {{old('type')==$type->id?"selected":""}} value="{{$type->id}}"> {{$type->title}} </option>
            ...
            <div class="card-body">
            <form id="formID" class="formular form-horizontal ls_form" method="post" action="/CMS/Certificate">
                        @csrf
                       ...
                       <div class="col" id="cert_id_d">
                                <label class="control-label">رقم الشهادة:* </label>
                                    <input type="number" value="" class="form-control validate[required] text-input" id="cert_id"
                                ...
                                <label class="control-label"> العام:* </label>
                                    <select name="year" id="year" class="form-control" >
                                        ...
                                        @foreach($years as $year)
                                            <option {{old('year')==$year->title?"selected":""}} value="{{$year->title}}"> {{$year->title}} </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col" id="nameen" style="display:none">
                                <label class="control-label">اسم الطالب (E) : </label>
                                    <input type="text" value="{{old("nameEN")}}" class="form-control validate[required] text-input" id="nameEN"
                                           name="nameEN" placeholder="أدخل اسم الطالب اولا" disabled>
                        ...
                        <div class="row">
                            <div class="col" id="nationality_d" style="display:none">
                                <label class="control-label">الجنسية:* </label>
                                    <input type="hidden" value="" name="nationality_h" id="nationality_h">
                                    <input type="text" value="{{old("nationality")}}" class="form-control validate[required] text-input" id="nationality"
                          ...
                          <div class="col"id="place_birth_d" style="display:none">
                                <label class="control-label">مكان الولادة:* </label>
                                    <input type="hidden" value="" name="place_birth_h" id="place_birth_h">
                                    <input type="text" value="{{old("place_birth_h")}}" class="form-control validate[required] text-input" id="place_birth"
                           ...
                           <div class="col"  id="year_birth_d" style="display:none">
                                <label class="control-label">سنة الميلاد:* </label>
                                    <input type="hidden" value="" name="year_birth_h" id="year_birth_h">
                                    <input type="text" value="{{old("year_birth_h")}}" class="form-control validate[required] text-input" id="year_birth"
                                           name="year_birth" placeholder="أدخل اسم الطالب اولا" disabled>
                                    <div class="text-danger">{{$errors->first('year_birth')}}</div>
                                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="col"id="total_hours_d" style="display:none">
                                <label class="control-label">عدد الساعات:* </label>
                                    <input type="number" value="{{old("total_hours")}}" class="form-control text-input" id="total_hours"
                        ...
                        <div class="row" >
                            <div class="col"id="start_day_d" style="display:none">
                                <label class="control-label">المبتدئة بتاريخ:* </label>
                                    <input type="text" min="{{date('Y-m-d')}}" value="{{old("start_day")?old("start_day"):date('Y-m-d')}}"
                              ...
                              <div class="col"id="end_day_d" style="display:none">
                                <label class="control-label">المنتهية بتاريخ:* </label>
                                    <input type="text" min="{{date('Y-m-d')}}" value="{{old("end_day")?old("end_day"):date('Y-m-d')}}"
                                ...
                                <label class="control-label">التقدير:* </label>
                                    <select name="appreciation" id="appreciation" class="form-control">
                                        ...
                                        @foreach($appreciations as $appreciation)
                                            <option {{old('appreciation')==$appreciation->id?"selected":""}} value="{{$appreciation->id}}">
                                                {{$appreciation->title}}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row" >
                            <div class="col" id="certificate_fees_d" style="display:none">
                                <label class="control-label">رسوم الشهادة:* </label>
                                    <input type="number" onchange="setTwoNumberDecimal(this)" step="any" value="{{old("certificate_fees")}}" class="form-control text-input" id="certificate_fees"
                       ...
                       <div class="col"id="catch_receipt_id_d" style="display:none">
                                <label class="control-label">رقم سند القبض:* </label>
                                    <input type="number" value="{{old("catch_receipt_id")}}" class="form-control text-input" id="catch_receipt_id"
                        ...
                        <div class="row" >
                            <div class="col"id="release_date_d" style="display:none">
                                <label class="control-label"> تاريخ الاصدار:* </label>
                                    <input type="text" min="{{date('Y-m-d')}}" value="{{old("release_date")?old("release_date"):date('Y-m-d')}}"
                                           class="form-control fc-datepicker" id="release_date" name="release_date">
                            ...
                            <div class="col" id="student_name_d" style="display:none">
                                <label class="control-label">اسم الطالب / الهيئة :* </label>
                                    <input type="text" value="{{old("student_name")}}" class="form-control validate[required] text-input" id="place_birth"
                                           name="student_name"/>
                        ...
                        <div class="row" id="description_d" style="display:none">
                            <div class="col">
                                <label class="control-label"> الوصف: </label>
                                    <textarea name="description" style="width: 100%;height: auto;min-height: 150px;">{{old("description")}}</textarea>
                        ...
                        <div class="col" id="print_d" style="display:none">
                        ...
                        <div class="row last">
                            <div class="col">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                    ...
                                    <a id="cancel_bt" href="/CMS/Certificate/" class="btn btn-danger"> إلغاء</a>
                                </div>
                            </div>
                        </div><br>
