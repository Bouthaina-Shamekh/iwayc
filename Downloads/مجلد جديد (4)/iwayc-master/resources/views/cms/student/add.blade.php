...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                    <form id="formID" class="formular form-horizontal ls_form" method="post" action="/CMS/Student">
                        @csrf
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" value="{{$userL>0?$uY:$moneyWork->year}}" id="edu_year_h" name="edu_year_h">
                                    <input type="text" value="{{old('nameAR')}}" class="form-control validate[required] text-input" id="nameAR"
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="control-label">سنة الميلاد:* </label>
                                    ...
                                    <input type="number" value="{{old("birthday")?old("birthday"):date('Y')}}" class="form-control" id="birthday"
                                ...
                                <label class="control-label">الجنس:* </label>
                                    <select name="gender" id="gender" class="form-control">
                                        ...
                                        @foreach($genders as $gender)
                                            <option {{old("gender")==$gender->id?"selected":""}} value="{{$gender->id}}"> {{$gender->title}} </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="control-label">مكان الولادة:* </label>
                                    <input type="text" value="{{old("place_birth")}}" class="form-control validate[required] text-input" id="place_birth"
                                           name="place_birth" placeholder="أدخل مكان الولادة">
                        ...
                        <div class="row">
                         ...
                         <div class="col">
                                <label class="control-label">كيف سمعت عنا:* </label>
                                    <select name="how_listen" id="how_listen" class="form-control">
                                        <option value=""> اختر من القائمة.... </option>
                                        @foreach($hows as $how)
                                            <option {{old("how_listen")==$how->id?"selected":""}} value="{{$how->id}}"> {{$how->title}} </option>
                                        @endforeach
                                    </select>
                                </div>
                          ...
                          <div class="col">
                           ...
                           <div class="col">
                                ...
                                <label class="control-label">هاتف 3 الواتساب: </label>
                                    ...
                                    <input type="text" value="{{old("whatsup")}}" class="form-control text-input" id="whatsup"
                                           name="whatsup" placeholder="أدخل رقم الواتساب">
